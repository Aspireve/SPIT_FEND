...
const CustomBadge: React.FC<{ children: React.ReactNode; color: string }> = ({
  children,
  color,
}) => (
...
const EcoLevelSystem = ({ score = 2800 }) => {
  const levels = [
    ...
    },
    {
      ...
      title: "Eco Explorer",
      tagline:
        "Venturing beyond basics to discover new horizons of sustainability",
      badge: (
    ...
    },
    {
      ...
      badge: (
        <CustomBadge color="text-amber-500">
          ...
          <path
            d="M50 10 L90 25 L85 75 L50 90 L15 75 L10 25 Z"
            fill="currentColor"
          />
    ...
    },
    {
      ...
      title: "Eco Hero",
      tagline:
        "Inspiring communities through exemplary environmental leadership",
      badge: (
        <CustomBadge color="text-emerald-500">
          {/* Star with earth elements */}
          <path
            d="M50 5 L61 41 L95 41 L67 63 L79 95 L50 75 L21 95 L33 63 L5 41 L39 41 Z"
            fill="currentColor"
          />
